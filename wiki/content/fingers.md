...
| Fingers left on a hand | What happens |
|---|---|
| 5 | Nothing. |
| 1 to 4 | Each missing finger gives a 6% chance to fumble and drop things as you pick them up. |
| 0 | That hand can't hold anything. Whatever it was holding falls out. |

Snapping needs a thumb and a middle finger on the same hand. Gloves, and suits that cover the hands, hide missing fingers from people examining you.

Try `*wiggle` to see what you've got left.
